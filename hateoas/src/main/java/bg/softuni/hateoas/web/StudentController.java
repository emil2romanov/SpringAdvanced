...
public class StudentController {
    ...
    public ResponseEntity<CollectionModel<EntityModel<StudentDTO>>> all() {
        ...
        List<EntityModel<StudentDTO>> entityModels = studentService.
                getAllStudents().
                stream().
                map(s -> EntityModel.of(s, getStudentLinks(s))).toList();

        CollectionModel<EntityModel<StudentDTO>> collectionModel = CollectionModel.of(entityModels);
